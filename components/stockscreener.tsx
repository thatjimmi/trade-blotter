          ...
          {filteredStocks.map((stock) => (
            <div key={stock.symbol} 
              ...
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <div className="font-medium text-gray-200">{stock.symbol}</div>
                  <div className="text-xs text-gray-500">{stock.name}</div>
                </div>
              </div>
              <div className="flex items-center">
                <span className="px-2 py-0.5 text-xs bg-gray-800 rounded">{stock.status}</span>
              </div>
              <div className="flex items-center">{stock.sector}</div>
              <div className={`flex items-center ${stock.growth >= 0 ? 'text-green-400' : 'text-red-400'}`}>
              ...
              <div className="flex items-center">{formatNumber(stock.marketCap)}</div>
